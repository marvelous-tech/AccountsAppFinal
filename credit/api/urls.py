...
urlpatterns = [
    ...
    path('fund/', include([
        ...
        path('loan-recieve/', include([
            path('list/', views.CreditLoanReceiveRecordListAPIView.as_view(), name="fund_loan_recieve_list"),
            path('list-add/', views.CreditLoanReceiveRecordListCreateAPIView.as_view(), name="fund_loan_recieve_list_add"),
            path('view/<uuid:uuid>/', views.CreditLoanReceiveRecordRetrieveAPIView.as_view(), name="fund_loan_recieve_view"),
            path('view-update-delete/<uuid:uuid>/', views.CreditLoanReceiveRecordRetrieveUpdateAPIView.as_view(), name="fund_loan_recieve_view_update_delete"),
        ])),
